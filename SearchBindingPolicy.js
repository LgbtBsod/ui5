sap.ui.define([
    ...
    function applyRebindParams(mArgs) {
        ...
        if (iMax > 0) {
            // SAP OData v2: only $top is a valid system query option; bare "top" is not standard
        ...
        // Never override $inlinecount here — the ODataModel (defaultCountMode=Inline in manifest)
        // manages it; injecting "none" breaks inline count on SAP Gateway responses.
        if (Object.prototype.hasOwnProperty.call(oBindingParams.parameters, "$inlinecount")) {
            delete oBindingParams.parameters.$inlinecount;
        }
