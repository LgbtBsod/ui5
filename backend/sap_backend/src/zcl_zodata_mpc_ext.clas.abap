...
CLASS zcl_zodata_mpc_ext IMPLEMENTATION.
  ...
  METHOD define_function_imports.
    ...
    add_fi_param( io_fi = lo_fi iv_name = 'DB_KEY'       iv_edm_type = 'Binary'  iv_nullable = abap_false ).
    add_fi_param( io_fi = lo_fi iv_name = 'SessionGuid'  iv_edm_type = 'String'  iv_nullable = abap_false ).
