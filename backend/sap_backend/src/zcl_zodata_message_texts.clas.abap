CLASS zcl_zodata_message_texts DEFINITION
  ...
  PUBLIC SECTION.
    CONSTANTS c_msg_lock_acquire_required TYPE string VALUE 'db_key and session_guid are required for lock acquire'.
    CONSTANTS c_msg_lock_heartbeat_required TYPE string VALUE 'db_key and session_guid are required for lock heartbeat'.
    CONSTANTS c_msg_lock_release_required TYPE string VALUE 'db_key and session_guid are required for lock release'.
