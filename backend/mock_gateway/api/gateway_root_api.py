...
from api.gateway_validators import (
    _pick_text, _normalize_basic_payload, _apply_basic_payload,
    _next_checklist_id, _normalize_status_input,
)
...
def _build_new_root(db: Session, *, checklist_id: str, lpc: str, status: str, user_name: str, basic_values: dict) -> ChecklistRoot:
