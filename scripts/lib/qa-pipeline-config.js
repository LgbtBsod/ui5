const validators = [
  ...
  { name: 'gateway-parity-validator', file: 'run-gate.js gateway-parity-validator' },
  { name: 'sap-gateway-only-gate', file: 'sap-gateway-only-gate.js' },
  { name: 'smart-odata-contract-gate', file: 'smart-odata-contract-gate.js' },
  { name: 'architecture-gate', file: 'run-gate.js architecture-gate', mode: 'advisory' },
  ...
  { name: 'network-contract-verifier', file: 'network-contract-verifier.js', mode: 'advisory' },
