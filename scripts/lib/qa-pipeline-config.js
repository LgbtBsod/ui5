const validators = [
  ...
  { name: 'architecture-gate', file: 'architecture-gate.js' },
  { name: 'style-scan', file: 'style-scan.js' },
  { name: 'feature-scan', file: 'feature-scan.js' },
  { name: 'final-architecture-freeze-gate', file: 'ci/final-architecture-freeze-gate.js' },
  { name: 'legacy-ban-gate', file: 'ci/legacy-ban-gate.js' },
  { name: 'shadow-duplicate-gate', file: 'ci/shadow-duplicate-gate.js' },
  { name: 'runtime-duplication-gate', file: 'runtime-duplication-gate.js' },
  { name: 'controller-purity-gate', file: 'controller-purity-gate.js' },
  { name: 'runtime-settings-gate', file: 'runtime-settings-gate.js' },
  { name: 'function-length-gate', file: 'function-length-gate.js' },
  { name: 'js-line-limit-gate', file: 'js-line-limit-gate.js' },
  { name: 'layer-map', file: 'layer-map.js' },
  ...
  { name: 'dedup-fingerprint-gate', file: 'dedup-fingerprint-gate.js' },
  ...
  { name: 'listener-registration-gate', file: 'ci/listener-registration-gate.js' },
  { name: 'uiState-workflow-mirror-gate', file: 'ci/uiState-workflow-mirror-gate.js' },
  ...
  { name: 'style-purity-gate', file: 'style-purity-gate.js' },
  { name: 'design-language-gate', file: 'design-language-gate.js' },
  { name: 'final-static-qa', file: 'final-static-qa.js' },
  { name: 'enterprise-readiness-gate', file: 'enterprise-readiness-gate.js' },
  ...
  { name: 'dead-code-gate', file: 'ci/dead-code-gate.js' },
  { name: 'dependency-drift-gate', file: 'ci/dependency-drift-gate.js' }
];
