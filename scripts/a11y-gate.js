...
const requiredDocs = ['docs/DEVELOPMENT_PLAN.md', 'app/styles/modules/01_theme-modes.css', 'app/views/fragment/DetailControlRail.fragment.xml'];
...
const css = readText(ROOT, 'app/styles/modules/01_theme-modes.css');
if (!css.includes('prefers-reduced-motion: reduce')) fail('C2 gate failed: reduced-motion policy not found in app/styles/modules/01_theme-modes.css');

const rail = readText(ROOT, 'app/views/fragment/DetailControlRail.fragment.xml');
