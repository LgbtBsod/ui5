sap.ui.define([
    ...
    function normalizeRootKey(sRootId) {
        // Do not strip dashes: real SAP Gateway expects the UUID in its original format.
        // Uppercase only for consistent OData key comparison.
        return String(sRootId || "").trim().toUpperCase();
    }
