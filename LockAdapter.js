    ...
    function create(mDeps) {
        ...
        return {
            acquire: function (mArgs) {
                ...
                return GatewayAdapterSupport.postFunction("LockAcquire", withUserName({ RootKey: sRootId, SessionGuid: sSession, Force: !!(mArgs && mArgs.force), StealFrom: (mArgs && mArgs.stealFrom) || (mArgs && mArgs.force ? sSession : "") })).then(function (oResult) {
            ...
            heartbeat: function (mArgs) {
                ...
                return GatewayAdapterSupport.postFunction("LockHeartbeat", withUserName({ RootKey: sRootId, SessionGuid: sToken })).then(function (oResult) {
            ...
            release: function (mArgs) {
                var sRootId = mArgs && mArgs.rootId;
                var sToken = normalizeLockToken(mArgs);
                return GatewayAdapterSupport.postFunction("LockRelease", withUserName({ RootKey: sRootId, SessionGuid: sToken })).then(function (oResult) {
