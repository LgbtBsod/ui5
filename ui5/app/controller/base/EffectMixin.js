sap.ui.define([
    ...
    return {
        showI18nToast: function (sI18nKey, aArgs) {
            return FeedbackCoordinator.showGlobalMessage(this, "info", sI18nKey, aArgs || [], sI18nKey);
        },

        showI18nError: function (sI18nKey, aArgs) {
            return FeedbackCoordinator.showGlobalMessage(this, "error", sI18nKey, aArgs || [], sI18nKey);
        },
