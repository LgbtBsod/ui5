sap.ui.define([], function () {
    ...
    var ALLOWED_FUNCTION_IMPORTS = Object.freeze([
        FUNCTION_IMPORTS.ANALYTICS_REFRESH_TRIGGER,
        FUNCTION_IMPORTS.AUTO_SAVE,
        FUNCTION_IMPORTS.COPY_CHECKLIST,
        FUNCTION_IMPORTS.CREATE_CHECKLIST,
        FUNCTION_IMPORTS.GET_HIERARCHY,
        FUNCTION_IMPORTS.LOCK_ACQUIRE,
        FUNCTION_IMPORTS.LOCK_HEARTBEAT,
        FUNCTION_IMPORTS.LOCK_RELEASE,
        FUNCTION_IMPORTS.REPORT_EXPORT,
        FUNCTION_IMPORTS.SAVE_CHANGES
    ]);

    var FUNCTION_IMPORTS_WITH_QUERY_PARAMS = Object.freeze([
        FUNCTION_IMPORTS.ANALYTICS_REFRESH_TRIGGER,
        FUNCTION_IMPORTS.GET_HIERARCHY
    ]);

    var ALLOWED_GET_FUNCTION_IMPORTS = Object.freeze([
        FUNCTION_IMPORTS.GET_HIERARCHY
    ]);

    return {
        ALLOWED_FUNCTION_IMPORTS: ALLOWED_FUNCTION_IMPORTS,
        ALLOWED_GET_FUNCTION_IMPORTS: ALLOWED_GET_FUNCTION_IMPORTS,
        DISALLOWED_PATHS: DISALLOWED_PATHS,
        ENTITY_SETS: ENTITY_SETS,
        FUNCTION_IMPORTS: FUNCTION_IMPORTS,
        FUNCTION_IMPORTS_WITH_QUERY_PARAMS: FUNCTION_IMPORTS_WITH_QUERY_PARAMS,
        REQUEST: REQUEST
    };
});
