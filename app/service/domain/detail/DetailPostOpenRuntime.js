sap.ui.define([
...
], function (Effects, CloneUtil, StatePaths, WorkflowContracts, ModelContracts, DetailUseCaseConstants) {
    "use strict";
    ...
    function buildEditableDetailEffects(sDbKey, oOptions) {
        ...
        return [
            ...
            Effects.modelPatch(MODELS.STATE, StatePaths.ACTIVE_OBJECT_ID, sResolvedDbKey),
            Effects.modelPatch(MODELS.STATE, StatePaths.SELECTED_ID, sResolvedDbKey),
            Effects.modelPatch(MODELS.STATE, StatePaths.POST_OPEN_HYDRATED_ROOT_ID, sResolvedDbKey),
