sap.ui.define([], function () {
    ...
    function createModelStage(oComponent, mDeps) {
        ...
        var mModels = mDeps.ComponentModelBootstrapRuntime.createModels(oComponent, mDeps);
        return {
            models: mModels,
    ...
    function createCoreStage(oComponent, mDeps, mModels, mHelpers) {
        ...
        var oCoreRuntime = mDeps.ComponentCoreBootstrapRuntime.bootstrapComponentRuntime(oComponent, mDeps, mModels, {
