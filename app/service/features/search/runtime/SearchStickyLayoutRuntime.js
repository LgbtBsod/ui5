sap.ui.define([
    ...
    function syncSearchStickyOffsets(oController, oScrollHost) {
        ...
        var iSummaryRailHeight = SearchStickyDomRuntime.resolveDomHeight(oSummaryRailDom, ".searchResultsSummaryRail");
        var iFilterHeight = SearchStickyDomRuntime.resolveDomHeight(oFilterCard, ".searchFilterCardDense");
        var iActionHeight = SearchStickyDomRuntime.resolveDomHeight(oActionRail, ".searchResultsActionRail");
        var iToolbarHeight = SearchStickyDomRuntime.resolveDomHeight(oToolbarRail, ".searchSmartToolbarRail");
        ...
        if (bCompactSticky) {
            ...
            SearchStickyDomRuntime.setSearchStickyTop(
                oResultsToolbarDom,
