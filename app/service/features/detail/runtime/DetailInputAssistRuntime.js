sap.ui.define([
...
], function (SelectDialog, StandardListItem, Filter, FilterOperator, OperationSourceContracts, ModelStateRuntime, ModelContracts, DetailFieldContracts, JsRuntime) {
    "use strict";
    ...
    function onPersonInputChange(_oController, oEvent, mHooks) {
    ...
    function onPersonSuggest(_oController, oEvent, mHooks) {
        var oSource = oEvent && oEvent.getSource && oEvent.getSource();
        if (!mHooks.isEditMode()) {
            return;
        }
    ...
    function onPersonSuggestionSelected(_oController, oEvent, mHooks) {
        var oSource = oEvent && oEvent.getSource && oEvent.getSource();
        var oSelectedItem = oEvent && oEvent.getParameter && oEvent.getParameter("selectedItem");
        var sTarget = mHooks.personTargetFromSource(oSource);
        var sSelectedValue = "";
    ...
    return {
        ...
        onPersonSuggest: onPersonSuggest,
        onPersonSuggestionSelected: onPersonSuggestionSelected,
