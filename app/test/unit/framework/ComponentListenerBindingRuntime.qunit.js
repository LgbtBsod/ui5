sap.ui.define([
    ...
    "PRODUCTION_CONTROL_CHECKLIST/service/runtime/component/ComponentListenerBindingRuntime",
    "PRODUCTION_CONTROL_CHECKLIST/model/StatePaths"
], function (JSONModel, ComponentListenerBindingRuntime, StatePaths) {
    "use strict";

    QUnit.module("framework/ComponentListenerBindingRuntime");
    ...
    QUnit.test("listener does not auto-resume pending navigation on settled save state", function (assert) {
        ...
        ComponentListenerBindingRuntime.attachLifecycleBindings({
