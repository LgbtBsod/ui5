...
sap.ui.define([
	 ...
	 * @author SAP SE
	 * @alias sap.ui.comp.odata.MetadataAnalyser
	 */
	 ...
	 * @public
	 */
	MetadataAnalyser.prototype.getValueListAnnotationLazy = function(sPath, sBindingContextPath, oFunctionImportProperty) {
		var	oProperty,
			oValueListsPromise,
			oBindingContext,
			oPromise,
		...
		oPromise = new Promise(function(fResolve, fReject) {
			if (sPath && this._oMetaModel) {
				...
				if (oPropertyContext) {
					...
					if (oFunctionImportProperty && oFunctionImportProperty["sap:value-list"]) {
						oProperty["sap:value-list"] = oFunctionImportProperty["sap:value-list"];
					}
	...
	MetadataAnalyser.prototype._getFunctionImportValueListAnnotationLazy = function(oFunctionImport, oFunctionImportProperty, sMainPath, sMainBindingContextPath) {
		...
		if (oValueList) {
			...
			return this._loadValueListAnnotationForFunctionImport(oFunctionImport.name, oFunctionImportProperty.name, sMainPath, sMainBindingContextPath, oFunctionImportProperty);
	};
	 ...
	 * @private
	 */
	MetadataAnalyser.prototype._loadValueListAnnotationForFunctionImport = function(sFunctionImportName, sParameterName, sMainPath, sMainBindingContextPath, oFunctionImportProperty) {
		var mAnnotation = {
				additionalAnnotations: []
			}, sPath,
		...
		var oPromise = new Promise(function(fResolve, fReject) {
			if (sPath && this._oMetaModel) {
				...
				oValueListsFunctionImportPromise.then(function(mValueList) {
					...
					var oValueListMainSet = this.getValueListAnnotationLazy(sMainPath, sMainBindingContextPath, oFunctionImportProperty);
