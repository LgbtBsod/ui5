...
sap.ui.define([
	...
	"sap/ui/fl/changeHandler/condenser/Classification"
		...
		MoveGroups.getCondenserInfo = function(oChange, mPropertyBag) {
			...
			const oForm = oMovedGroup.getParent();
			const oFormParent = oForm.getParent();
			// Expandable SmartForms have a Panel between the form and the SmartForm control
			const oSmartFormControl = oFormParent.isA("sap.ui.comp.smartform.SmartForm") ? oFormParent : oFormParent.getParent();
			return {
