...
sap.ui.define([
	...
	AddGroup.getCondenserInfo = function(oChange, mPropertyBag) {
		...
		let oSmartFormControl = oAddedGroup.getParent().getParent();

		while (oSmartFormControl && !oSmartFormControl.isA("sap.ui.comp.smartform.SmartForm") && oSmartFormControl.getParent) {
			oSmartFormControl = oSmartFormControl.getParent();
		}
