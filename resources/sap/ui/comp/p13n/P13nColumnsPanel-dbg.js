...
// Provides control sap.ui.comp.p13n.P13nColumnsPanel.
sap.ui.define([
	...
	"../library"
], function(Localization, Element, Library, CoreLibrary, Locale, ChangeReason, JSONModel, BindingMode, IconPool, library, Table, Column, ColumnListItem, P13nPanel, P13nColumnsItem, SearchField, Text, Button, OverflowToolbar, OverflowToolbarLayoutData, OverflowToolbarButton, ToolbarSpacer, jQuery, compLibrary) {
	"use strict";
	 ...
	 * @private
	 * @since 1.144.0
	 * @alias sap.ui.comp.p13n.P13nColumnsPanel
	 */
	var P13nColumnsPanel = P13nPanel.extend("sap.ui.comp.p13n.P13nColumnsPanel", /** @lends sap.ui.comp.p13n.P13nColumnsPanel.prototype */
		{
			metadata: {
				library: "sap.ui.comp",
				properties: {
				...
				aggregations: {
					 ...
					 */
					columnsItems: {
						type: "sap.ui.comp.p13n.P13nColumnsItem",
						multiple: true,
				...
				events: {
					 ...
					 * @deprecated As of version 1.50, replaced by extended event {@link sap.ui.comp.p13n.P13nColumnsPanel#event:changeColumnsItems}
					 * @since 1.26.0
					 */
					addColumnsItem: {
						deprecated: true,
