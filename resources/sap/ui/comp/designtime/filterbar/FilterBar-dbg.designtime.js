...
sap.ui.define([], function() {
	...
	return {
		...
		customData: {
			/**
			 * If this property is set to <code>true</code>, the FilterBar will not create a variant management control on initial load.
			 * Should be used only if there is no <code>persistencyKey</code> property set and no SmartVariantManagement associated.
			 */
			preventVariantCreation: {
				type: "boolean",
				defaultValue: false,
				since: "1.143"
			}
