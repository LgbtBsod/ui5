		...
		return new Promise(function(resolve, reject) {
			sap.ui.require(["sap/m/p13n/Popup", "sap/m/p13n/SelectionPanel"], function(Popup, SelectionPanel) {
				...
				var oSelectionPanel = new SelectionPanel({
					title: Library.getResourceBundleFor("sap.ui.comp.designtime").getText("SMARTTABLE_RTA_REARRANGE_TOOLBAR_CONTENT_TABLE_TITLE"),
					enableCount: false,
					showHeader: false
				});
				var oPopup = new Popup({
					title: Library.getResourceBundleFor("sap.ui.comp.designtime").getText("SMARTTABLE_RTA_REARRANGE_TOOLBAR_CONTENT_TITLE"),
