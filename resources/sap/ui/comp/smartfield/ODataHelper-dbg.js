...
sap.ui.define([
	...
	/**
	 * @private
	 * @class Utility class to access OData metadata.
	 ...
	 * @alias sap.ui.comp.smartfield.ODataHelper
	 * @author SAP SE
	 * @version 1.144.0
	 * @since 1.28.0
	 */
	...
	/**
	 * Returns the property of the Unit of Measure.
	 *
	 * @param {object} oMetaData the metadata used to initialize the factory
	 * @param {object} oMetaData.entitySet the name of the OData entity set
	 * @param {object} oMetaData.entityType the name of the OData entity type
	 ...
	 * @param {string} oMetaData.path the path identifying the OData property
	 * @param {object} oMetaData.annotations the current annotations
	 * @returns {object} oMetaData.property of the OData property
	 * @private
	 */
	ODataHelper.prototype.getUomProperty = function(oMetaData) {
		return oMetaData?.annotations?.uom?.property;
	};
