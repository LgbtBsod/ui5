...
sap.ui.define([], function() {
	...
	/**
	 * @class Utility to access annotations for SmartField control.
	 *
	 * As a translation of OData V2 annotations to vocabulary-based OData V4 annotations
	 * is applied this utility only considers V4 annotations.
	 *
	 * @alias sap.ui.comp.smartfield.AnnotationHelper
	 * @author SAP SE
	 * @version 1.144.0
	 * @private
	 * @since 1.29.0
