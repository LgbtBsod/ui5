...
sap.ui.define([
	...
	SmartField.prototype._onInnerControlToggled = function(oSettings) {
		...
		// SNOW: DINC0664158 - description is not updated when value changes while SmartField is not visible
		if (!oSettings.visible && !oSettings.visibleChanged) {
			oSettings.fetchIDAndDescription = true;
		}
	...
	SmartField.prototype._calculateCurrentState = function() {
		var bModeInitialized,
			...
			bRebindFactory = bValueListNoValidationValueChanged || !bModeInitialized || bDescriptionBindingPathChanged || bValuePropertyChanged || bModeChanged;
	 ...
	 * @private
	 * @ui5-restricted sap.ui.rta, sap.ui.comp.designtime.smartfield.SmartField.designtime
	 * @returns {Promise}
	 */
