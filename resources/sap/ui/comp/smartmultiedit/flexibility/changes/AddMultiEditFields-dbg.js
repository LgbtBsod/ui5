...
sap.ui.define([
	 ...
	 *
	 * @alias sap.ui.comp.smartmultiedit.flexibility.changes.AddMultiEditFields
	 * @author SAP SE
	 * @version 1.144.0
	 */
	...
	AddMultiEditFields.revertChange = function (oChange, oGroup, mPropertyBag) {
		...
		if (oSelector) {
			...
			.then(function () {
				...
				// Refresh the indexing of sap.ui.comp.smartmultiedit.Field instances in their sap.ui.comp.smartmultiedit.Container
				var oContainer = this._getContainerFromGroup(oGroup);
				if (oContainer) {
